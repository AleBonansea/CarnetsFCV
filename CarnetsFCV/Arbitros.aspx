<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Arbitros.aspx.cs" Inherits="CarnetsFCV.Arbitros" %>
    ...
    <div class="row">
        <div class="col">        
            ...
            <div class="divGrilla">
                ...
                <asp:GridView  CssClass="grilla"  ID="gvArbitros" runat="server" ShowHeaderWhenEmpty="True" Font-Names="Arial" GridLines="None">
