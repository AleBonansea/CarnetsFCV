    ...
    <div class="row">
        <div class="col">
            ...
            <div class="divGrilla">
                ...
                <asp:GridView AutoGenerateColumns="false" CssClass="grilla" ID="gvJugadores" runat="server" ShowHeaderWhenEmpty="True"
                    Font-Names="Arial" GridLines="None" DataKeyNames="Id"  OnRowDataBound="gvJugadores_RowDataBound"
